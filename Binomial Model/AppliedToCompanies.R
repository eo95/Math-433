...
tesco.P <- parameterize(S=277.5,r=.004452,T_exp=52/252,n=20,K=270,sigma=tesco.sigma,choice=2,eur=F,recombine = F)
tesco.P.bs <- bs_parameterize(S=277.5,r=.004452,T_exp=52/252,K=270,sigma=tesco.sigma,eur=F,put=F)
tesco.model <- binomial_pricing(tesco.P,payoff=call_payoff)
tesco.model.bs <- black_scholes(tesco.P.bs)
tesco.model[[2]][1]
tesco.P <- parameterize(S=277.5,r=.004452,T_exp=52/252,n=20,K=280,sigma=tesco.sigma,choice=2,eur=F,recombine = F)
tesco.model <- binomial_pricing(tesco.P,payoff=call_payoff)
tesco.model[[2]][1]
tesco.P <- parameterize(S=277.5,r=.004452,T_exp=52/252,n=20,K=290,sigma=tesco.sigma,choice=2,eur=F,recombine = F)
tesco.model <- binomial_pricing(tesco.P,payoff=call_payoff)
tesco.model[[2]][1]
...
adobe.P <- parameterize(S=452.13,r=.0033,T_exp=54/252,n=20,K=440,sigma=adobe.sigma,choice=2,eur=F,recombine = F)
adobe.P.bs <- bs_parameterize(S=452.13,r=.0033,T_exp=54/252,K=440,sigma=adobe.sigma,eur=F,put=F)
...
adobe.model <- binomial_pricing(adobe.P,payoff=call_payoff)
adobe.model[[2]][1]
adobe.P <- parameterize(S=452.13,r=.0033,T_exp=54/252,n=20,K=460,sigma=adobe.sigma,choice=2,eur=F,recombine = F)
adobe.model <- binomial_pricing(adobe.P,payoff=call_payoff)
adobe.model[[2]][1]
...
nyt.P.bs <- bs_parameterize(S=46.01,r=.0033,T_exp=29/252,K=45,sigma=nyt.sigma,D_CF=c(22/252,.09),eur=F,put=F)
...
novartis.P.bs <- bs_parameterize(S=77.64,r=-.0075,T_exp=53/252,K=76,sigma=novartis.sigma,D_CF=c(3.1,4/252),put=F)
